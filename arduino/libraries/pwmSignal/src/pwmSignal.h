...
class pwmSignal {
  private:
    static listPins _pinsList[MAX_NR_PINS];
    static uint8_t _nrPins;
    static uint8_t _nrInterrupts;
    static void _addPin(uint8_t pin, uint8_t dutyCycle);
    static void _delPin(uint8_t pin, uint8_t state);
